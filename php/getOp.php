...
session_start();
  ...
  $aux = 0;
    ...
    if($conexion)
    {
      $q = "select titulo, contenido, cat, id, positivos, negativos, youtube,facebook,twitter,instagram,nombre,video,img,id_header,id_button from opiniones order by rep desc ";
